    ...
    <div class="flex w-full items-center justify-center gap-4">
      ...
      <div class="flex w-full flex-col justify-center gap-4 overflow-hidden">
        <div class="flex flex-col gap-2">
          <span class="h-4 w-2/3 animate-pulse rounded-[3px] bg-zinc-300 dark:bg-zinc-700 sm:w-1/3"></span>
          <span class="h-4 w-3/4 animate-pulse rounded-[3px] bg-zinc-300 dark:bg-zinc-700 sm:w-2/4"></span>
        </div>
      </div>
    </div>
  </div>
